import { shareRecipe } from '../data/requests.js';
import { notificationHandler } from './notification.js';
import { redirect } from './redirect.js';

export const share = async (e, ctx) => {
    e.preventDefault();
    ...
    try {
        ...
        const response = await shareRecipe({
            method: 'POST',
            headers: {
        ...
        notificationHandler.fiveSecondClose('Successful share!', 'success');
        setTimeout(() => {
            redirect('/');
        }, 2000);
    } catch (error) { return; }
